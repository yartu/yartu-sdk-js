 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.yartu.ListApplicationTokenRequest,
 *   !proto.yartu.ListApplicationTokenResponse>}
 */
const methodDescriptor_YAccount_listApplicationToken = new grpc.web.MethodDescriptor(
  '/yartu.YAccount/listApplicationToken',
  grpc.web.MethodType.UNARY,
  proto.yartu.ListApplicationTokenRequest,
  proto.yartu.ListApplicationTokenResponse,
  /**
   * @param {!proto.yartu.ListApplicationTokenRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.yartu.ListApplicationTokenResponse.deserializeBinary
);


/**
 * @param {!proto.yartu.ListApplicationTokenRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.yartu.ListApplicationTokenResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.yartu.ListApplicationTokenResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.yartu.YAccountClient.prototype.listApplicationToken =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/yartu.YAccount/listApplicationToken',
      request,
      metadata || {},
      methodDescriptor_YAccount_listApplicationToken,
      callback);
};
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.yartu.ListApplicationTokenResponse>}
 *     Promise that resolves to the response
 */
proto.yartu.YAccountPromiseClient.prototype.listApplicationToken =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/yartu.YAccount/listApplicationToken',
      request,
 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.yartu.UpsertApplicationTokenRequest,
 *   !proto.yartu.UpsertApplicationTokenResponse>}
 */
const methodDescriptor_YAccount_upsertApplicationToken = new grpc.web.MethodDescriptor(
  '/yartu.YAccount/upsertApplicationToken',
  grpc.web.MethodType.UNARY,
  proto.yartu.UpsertApplicationTokenRequest,
  proto.yartu.UpsertApplicationTokenResponse,
  /**
   * @param {!proto.yartu.UpsertApplicationTokenRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.yartu.UpsertApplicationTokenResponse.deserializeBinary
);


/**
 * @param {!proto.yartu.UpsertApplicationTokenRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.yartu.UpsertApplicationTokenResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.yartu.UpsertApplicationTokenResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.yartu.YAccountClient.prototype.upsertApplicationToken =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/yartu.YAccount/upsertApplicationToken',
      request,
      metadata || {},
      methodDescriptor_YAccount_upsertApplicationToken,
      callback);
};
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.yartu.UpsertApplicationTokenResponse>}
 *     Promise that resolves to the response
 */
proto.yartu.YAccountPromiseClient.prototype.upsertApplicationToken =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/yartu.YAccount/upsertApplicationToken',
      request,
