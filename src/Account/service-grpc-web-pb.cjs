 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.yartu.UploadSignatureInlineImageRequest,
 *   !proto.yartu.UploadSignatureInlineImageResponse>}
 */
const methodDescriptor_YAccount_uploadSignatureInlineImage = new grpc.web.MethodDescriptor(
  '/yartu.YAccount/uploadSignatureInlineImage',
  grpc.web.MethodType.UNARY,
  proto.yartu.UploadSignatureInlineImageRequest,
  proto.yartu.UploadSignatureInlineImageResponse,
  /**
   * @param {!proto.yartu.UploadSignatureInlineImageRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.yartu.UploadSignatureInlineImageResponse.deserializeBinary
);


/**
 * @param {!proto.yartu.UploadSignatureInlineImageRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.yartu.UploadSignatureInlineImageResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.yartu.UploadSignatureInlineImageResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.yartu.YAccountClient.prototype.uploadSignatureInlineImage =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/yartu.YAccount/uploadSignatureInlineImage',
      request,
      metadata || {},
      methodDescriptor_YAccount_uploadSignatureInlineImage,
      callback);
};
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.yartu.UploadSignatureInlineImageResponse>}
 *     Promise that resolves to the response
 */
proto.yartu.YAccountPromiseClient.prototype.uploadSignatureInlineImage =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/yartu.YAccount/uploadSignatureInlineImage',
      request,
 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.yartu.GetMobileConfigRequest,
 *   !proto.yartu.GetMobileConfigResponse>}
 */
const methodDescriptor_YAccount_getMobileConfig = new grpc.web.MethodDescriptor(
  '/yartu.YAccount/getMobileConfig',
  grpc.web.MethodType.UNARY,
  proto.yartu.GetMobileConfigRequest,
  proto.yartu.GetMobileConfigResponse,
  /**
   * @param {!proto.yartu.GetMobileConfigRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.yartu.GetMobileConfigResponse.deserializeBinary
);


/**
 * @param {!proto.yartu.GetMobileConfigRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.yartu.GetMobileConfigResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.yartu.GetMobileConfigResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.yartu.YAccountClient.prototype.getMobileConfig =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/yartu.YAccount/getMobileConfig',
      request,
      metadata || {},
      methodDescriptor_YAccount_getMobileConfig,
      callback);
};
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.yartu.GetMobileConfigResponse>}
 *     Promise that resolves to the response
 */
proto.yartu.YAccountPromiseClient.prototype.getMobileConfig =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/yartu.YAccount/getMobileConfig',
      request,
