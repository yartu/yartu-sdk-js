 ...
 * @const
 */
proto.yartu.Contact.repeatedFields_ = [9];
...
proto.yartu.Contact.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    cType: jspb.Message.getFieldWithDefault(msg, 8, 0),
...
/**
 * optional AddressBook addressbook = 2;
 * @return {?proto.yartu.AddressBook}
 */
...
/**
 * optional int64 c_type = 8;
 * @return {number}
 */
proto.yartu.Contact.prototype.getCType = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 8, 0));
};
 ...
 * @return {!proto.yartu.Contact} returns this
 */
proto.yartu.Contact.prototype.setCType = function(value) {
  return jspb.Message.setProto3IntField(this, 8, value);
};
...
/**
 * optional AddressBook addressbook = 3;
 * @return {?proto.yartu.AddressBook}
 */
...
/**
 * optional int64 addressbook_id = 1;
 * @return {number}
 */
