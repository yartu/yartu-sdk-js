 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.yartu.ListSessionUserRequest,
 *   !proto.yartu.ListSessionUserResponse>}
 */
const methodDescriptor_YConference_listSessionUser = new grpc.web.MethodDescriptor(
  '/yartu.YConference/listSessionUser',
  grpc.web.MethodType.UNARY,
  proto.yartu.ListSessionUserRequest,
  proto.yartu.ListSessionUserResponse,
  /**
   * @param {!proto.yartu.ListSessionUserRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.yartu.ListSessionUserResponse.deserializeBinary
);


/**
 * @param {!proto.yartu.ListSessionUserRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.yartu.ListSessionUserResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.yartu.ListSessionUserResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.yartu.YConferenceClient.prototype.listSessionUser =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/yartu.YConference/listSessionUser',
      request,
      metadata || {},
      methodDescriptor_YConference_listSessionUser,
      callback);
};
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.yartu.ListSessionUserResponse>}
 *     Promise that resolves to the response
 */
proto.yartu.YConferencePromiseClient.prototype.listSessionUser =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/yartu.YConference/listSessionUser',
      request,
