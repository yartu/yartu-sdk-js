 ...
 * @const
 */
proto.yartu.UpsertConferenceRequest.repeatedFields_ = [9,10];
...
proto.yartu.UpsertConferenceRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    remindersList: (f = jspb.Message.getRepeatedField(msg, 9)) == null ? undefined : f,
...
/**
 * repeated ConferenceParticipant participants = 10;
...
proto.yartu.UpsertConferenceRequest.prototype.getParticipantsList = function() {
  return /** @type{!Array<!proto.yartu.ConferenceParticipant>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.yartu.ConferenceParticipant, 10));
};
...
proto.yartu.UpsertConferenceRequest.prototype.addParticipants = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 10, opt_value, proto.yartu.ConferenceParticipant, opt_index);
};
