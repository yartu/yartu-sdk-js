  ...
  class Conference {
    ...
    upsertInstantConference() {
      return new Promise((resolve, reject) => {
        ...
        this.client.upsertInstantConference(
          request,
          this.metadata,
          (error, response) => {
            if (error) {
    ...
    listConferenceRecords(conferenceUuid = null) {
      return new Promise((resolve, reject) => {
        ...
        this.client.listConferenceRecords(
          request,
          this.metadata,
          (error, response) => {
            if (error) {
    ...
    listSessionParticipant(conferenceUuid) {
      return new Promise((resolve, reject) => {
        ...
        this.client.listSessionParticipant(
          request,
          this.metadata,
          (error, response) => {
            if (error) {
    ...
    checkPublicConference(conferenceUuid) {
      return new Promise((resolve, reject) => {
        ...
        this.client.checkPublicConference(
          request,
          this.metadata,
          (error, response) => {
            if (error) {
    ...
    getPublicConference(conferenceUuid, name) {
      return new Promise((resolve, reject) => {
        ...
        this.client.getPublicConference(
          request,
          this.metadata,
          (error, response) => {
            if (error) {
    ...
    startPublicConference(conferenceUuid, password) {
      return new Promise((resolve, reject) => {
        ...
        this.client.startPublicConference(
          request,
          this.metadata,
          (error, response) => {
            if (error) {
    ...
    duplicateConference(conferenceId) {
      return new Promise((resolve, reject) => {
        ...
        this.client.duplicateConference(
          request,
          this.metadata,
          (error, response) => {
            if (error) {
        ...
        this.client.callYartuUser(request, this.metadata, (error, response) => {
          if (error) {
            ...
            try {
              ...
              console.log(`[error] on callYartuUser, err: ${error_}`);
              reject({
                code: code,
                message: response.getMessage()
              });
    ...
    copyConferenceRecordToDrive(sessionId, recordUUID, repoId, path) {
      return new Promise((resolve, reject) => {
        ...
        this.client.copyConferenceRecordToDrive(
          request,
          this.metadata,
          (error, response) => {
            if (error) {
