...
goog.exportSymbol('proto.yartu.Package', null, global);
 ...
 * @constructor
 */
proto.yartu.Package = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.yartu.Package, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.yartu.Package.displayName = 'proto.yartu.Package';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.yartu.Package.prototype.toObject = function(opt_includeInstance) {
  return proto.yartu.Package.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.yartu.Package} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.yartu.Package.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, 0),
    ...
    minUserCount: jspb.Message.getFieldWithDefault(msg, 9, 0),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.yartu.Package}
 */
proto.yartu.Package.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.yartu.Package;
  return proto.yartu.Package.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.yartu.Package} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.yartu.Package}
 */
proto.yartu.Package.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.yartu.Package.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.yartu.Package.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.yartu.Package} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.yartu.Package.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f !== 0) {
    writer.writeInt64(
 ...
 * @return {number}
 */
proto.yartu.Package.prototype.getId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
 ...
 */
proto.yartu.Package.prototype.setId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.yartu.Package.prototype.getName = function() {
 ...
 * @return {!proto.yartu.Package} returns this
 */
proto.yartu.Package.prototype.setName = function(value) {
 ...
 * @return {string}
 */
proto.yartu.Package.prototype.getCode = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.yartu.Package} returns this
 */
proto.yartu.Package.prototype.setCode = function(value) {
  return jspb.Message.setField(this, 3, value);
};
 ...
 * @return {!proto.yartu.Package} returns this
 */
proto.yartu.Package.prototype.clearCode = function() {
  return jspb.Message.setField(this, 3, undefined);
};
 ...
 * @return {boolean}
 */
proto.yartu.Package.prototype.hasCode = function() {
  return jspb.Message.getField(this, 3) != null;
};
 ...
 * @return {string}
 */
proto.yartu.Package.prototype.getUuid = function() {
 ...
 * @return {!proto.yartu.Package} returns this
 */
proto.yartu.Package.prototype.setUuid = function(value) {
 ...
 * @return {!proto.yartu.Package} returns this
 */
proto.yartu.Package.prototype.clearUuid = function() {
 ...
 * @return {boolean}
 */
proto.yartu.Package.prototype.hasUuid = function() {
  return jspb.Message.getField(this, 4) != null;
};


/**
 * optional JSON features = 5;
 * @return {?proto.JSON}
 */
proto.yartu.Package.prototype.getFeatures = function() {
  return /** @type{?proto.JSON} */ (
    jspb.Message.getWrapperField(this, common_grpc_definitions_pb.JSON, 5));
};
 ...
 * @return {!proto.yartu.Package} returns this
*/
proto.yartu.Package.prototype.setFeatures = function(value) {
 ...
 * @return {!proto.yartu.Package} returns this
 */
proto.yartu.Package.prototype.clearFeatures = function() {
 ...
 * @return {boolean}
 */
proto.yartu.Package.prototype.hasFeatures = function() {
 ...
 * @return {!proto.yartu.Package} returns this
 */
proto.yartu.Package.prototype.clearPrice = function() {
...
/**
 * optional int64 min_user_count = 9;
 * @return {number}
 */
...
/**
 * optional int64 max_group_count = 7;
 * @return {number}
 */
...
/**
 * optional int64 max_group_member_count = 8;
 * @return {number}
 */
...
proto.yartu.Contract.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    packageDetail: (f = msg.getPackageDetail()) && proto.yartu.Package.toObject(includeInstance, f),
...
proto.yartu.Contract.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new proto.yartu.Package;
      reader.readMessage(value,proto.yartu.Package.deserializeBinaryFromReader);
...
proto.yartu.Contract.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      proto.yartu.Package.serializeBinaryToWriter
    );
  }
  f = message.getRealm();
  if (f != null) {
...
proto.yartu.Contract.prototype.getPackageDetail = function() {
  return /** @type{?proto.yartu.Package} */ (
    jspb.Message.getWrapperField(this, proto.yartu.Package, 4));
};


/**
 * @param {?proto.yartu.Package|undefined} value
 * @return {!proto.yartu.Contract} returns this
*/
 ...
 * @return {string}
 */
proto.yartu.Invoice.prototype.getDetail = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 8, ""));
};
 ...
 * @return {!proto.yartu.Invoice} returns this
 */
proto.yartu.Invoice.prototype.setDetail = function(value) {
...
proto.yartu.CustomerRealm.prototype.getPackageDetail = function() {
  return /** @type{?proto.yartu.Package} */ (
    jspb.Message.getWrapperField(this, proto.yartu.Package, 2));
};
...
proto.yartu.RegisterFormLog.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    choosePackage: (f = msg.getChoosePackage()) && proto.yartu.Package.toObject(includeInstance, f),
    ...
    lastStep: jspb.Message.getFieldWithDefault(msg, 18, 0),
...
/**
 * optional Package choose_package = 3;
 * @return {?proto.yartu.Package}
 */
proto.yartu.RegisterFormLog.prototype.getChoosePackage = function() {
  return /** @type{?proto.yartu.Package} */ (
    jspb.Message.getWrapperField(this, proto.yartu.Package, 3));
};
 ...
 * @return {!proto.yartu.RegisterFormLog} returns this
*/
proto.yartu.RegisterFormLog.prototype.setChoosePackage = function(value) {
  return jspb.Message.setWrapperField(this, 3, value);
};
 ...
 * @return {!proto.yartu.RegisterFormLog} returns this
 */
proto.yartu.RegisterFormLog.prototype.clearChoosePackage = function() {
  return this.setChoosePackage(undefined);
};
 ...
 * @return {boolean}
 */
proto.yartu.RegisterFormLog.prototype.hasChoosePackage = function() {
  return jspb.Message.getField(this, 3) != null;
};
...
/**
 * optional JSON action_date_ats = 19;
 * @return {?proto.JSON}
 */
proto.yartu.RegisterFormLog.prototype.getActionDateAts = function() {
  return /** @type{?proto.JSON} */ (
    jspb.Message.getWrapperField(this, common_grpc_definitions_pb.JSON, 19));
};
 ...
 * @return {string}
 */
proto.yartu.GetRegisterFormRequest.prototype.getTabId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.yartu.GetRegisterFormRequest.prototype.setTabId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
...
proto.yartu.UpsertRegisterFormRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    taxLocation: jspb.Message.getFieldWithDefault(msg, 17, ""),
    step: jspb.Message.getFieldWithDefault(msg, 18, 0)
  };
...
proto.yartu.ListPackagesResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.yartu.Package.toObject, includeInstance),
    message: jspb.Message.getFieldWithDefault(msg, 3, "")
  };
 ...
 * @return {!Array<!proto.yartu.Package>}
 */
proto.yartu.ListPackagesResponse.prototype.getYartuPackageList = function() {
  return /** @type{!Array<!proto.yartu.Package>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.yartu.Package, 2));
};


/**
 * @param {!Array<!proto.yartu.Package>} value
 * @return {!proto.yartu.ListPackagesResponse} returns this
*/
...
/**
 * @param {!proto.yartu.Package=} opt_value
 * @param {number=} opt_index
 * @return {!proto.yartu.Package}
 */
proto.yartu.ListPackagesResponse.prototype.addYartuPackage = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.yartu.Package, opt_index);
};
