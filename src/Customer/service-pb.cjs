...
proto.yartu.RegisterFormLog.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    yartuPackage: (f = msg.getYartuPackage()) && proto.yartu.Package.toObject(includeInstance, f),
...
/**
 * optional Package yartu_package = 3;
 * @return {?proto.yartu.Package}
 */
proto.yartu.RegisterFormLog.prototype.getYartuPackage = function() {
  return /** @type{?proto.yartu.Package} */ (
 ...
 * @return {!proto.yartu.RegisterFormLog} returns this
*/
proto.yartu.RegisterFormLog.prototype.setYartuPackage = function(value) {
  return jspb.Message.setWrapperField(this, 3, value);
};
 ...
 * @return {!proto.yartu.RegisterFormLog} returns this
 */
proto.yartu.RegisterFormLog.prototype.clearYartuPackage = function() {
  return this.setYartuPackage(undefined);
};
 ...
 * @return {boolean}
 */
proto.yartu.RegisterFormLog.prototype.hasYartuPackage = function() {
  return jspb.Message.getField(this, 3) != null;
};
