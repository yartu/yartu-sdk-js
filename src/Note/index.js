  ...
  class Note {
    ...
    listNotebook = () => {
      return new Promise((resolve, reject) => {
        ...
        this.client.listNotebook(request, this.metadata, (error, response) => {
          if (error) {
    ...
    deleteSharedNotebook(notebookId, sharedNotebookId) {
      return new Promise((resolve, reject) => {
        ...
        this.client.deleteSharedNotebook(
          request,
          this.metadata,
          (error, response) => {
            if (error) {
    ...
    listNote = (notebookId = null, queryRequest = {}) => {
      return new Promise((resolve, reject) => {
        ...
        this.client.listNote(request, this.metadata, (error, response) => {
          if (error) {
            handleError(error, reject);
          } else {
            const code = response.getCode();
    ...
    getNote = (noteId) => {
      return new Promise((resolve, reject) => {
        ...
        this.client.getNote(request, this.metadata, (error, response) => {
          if (error) {
            handleError(error, reject);
          } else {
            const code = response.getCode();
    ...
    upsertNote = (noteData) => {
      return new Promise((resolve, reject) => {
        ...
        for (const bindedTask of bindedTasks) {
          ...
          parsedTask.setIsComplete(
            bindedTask.attributes.is_complete.nodeValue === 'true'
          );

          if (
            bindedTask.attributes.hasOwnProperty('reminder') &&
            bindedTask.attributes.reminder.nodeValue
          ) {
          ...
          if (
            bindedTask.attributes.hasOwnProperty('deadline') &&
            bindedTask.attributes.deadline.nodeValue
          ) {
        ...
        this.client.upsertNote(request, this.metadata, (error, response) => {
          if (error) {
            handleError(error, reject);
          } else {
            const code = response.getCode();
                  ...
                  if (bindedTask.attributes.task_id.nodeValue == 0) {
                    try {
                      const savedTask = savedTasks.find(
                        (t) =>
                          t.randomId ===
                          bindedTask.attributes.random_id.nodeValue
                      );
                      bindedTask.setAttribute('task_id', savedTask.id);
                    } catch (error_) {
                      console.log('task cannot synced:', error_);
                    }
                  }
                }
    ...
    starNote = (noteData) => {
      return new Promise((resolve, reject) => {
        ...
        this.client.starNote(request, this.metadata, (error, response) => {
          if (error) {
            handleError(error, reject);
          } else {
            const code = response.getCode();
    ...
    moveNote = (moveData) => {
      return new Promise((resolve, reject) => {
        ...
        this.client.moveNote(request, this.metadata, (error, response) => {
          if (error) {
            handleError(error, reject);
          } else {
            const code = response.getCode();
    ...
    copyNote = (copyData) => {
      return new Promise((resolve, reject) => {
        ...
        this.client.copyNote(request, this.metadata, (error, response) => {
          if (error) {
            handleError(error, reject);
          } else {
            const code = response.getCode();
    ...
    deleteNote = (noteIds) => {
      return new Promise((resolve, reject) => {
        ...
        this.client.deleteNote(request, this.metadata, (error, response) => {
          if (error) {
            handleError(error, reject);
          } else {
            const code = response.getCode();
    ...
    listNoteLabel = () => {
      return new Promise((resolve, reject) => {
        ...
        this.client.listNoteLabel(request, this.metadata, (error, response) => {
          if (error) {
            handleError(error, reject);
          } else {
            const code = response.getCode();
    ...
    pinNote = (pinData) => {
      return new Promise((resolve, reject) => {
        ...
        this.client.pinNote(request, this.metadata, (error, response) => {
          if (error) {
            handleError(error, reject);
          } else {
            const code = response.getCode();
    ...
    archiveNote = (archiveData) => {
      return new Promise((resolve, reject) => {
        ...
        this.client.archiveNote(request, this.metadata, (error, response) => {
          if (error) {
            handleError(error, reject);
          } else {
            const code = response.getCode();
    ...
    convertNote = (convertData) => {
      return new Promise((resolve, reject) => {
        ...
        this.client.convertNote(request, this.metadata, (error, response) => {
          if (error) {
            handleError(error, reject);
          } else {
            const code = response.getCode();
    ...
    getTask = (noteId, taskId) => {
      return new Promise((resolve, reject) => {
        ...
        this.client.getTask(request, this.metadata, (error, response) => {
          if (error) {
            handleError(error, reject);
          } else {
            const code = response.getCode();
    ...
    upsertTask = (noteId, taskData) => {
      ...
      return new Promise((resolve, reject) => {
        ...
        this.client.upsertTask(request, this.metadata, (error, response) => {
          if (error) {
            handleError(error, reject);
          } else {
            const code = response.getCode();
    ...
    deleteTask = (taskId) => {
      return new Promise((resolve, reject) => {
        ...
        this.client.deleteTask(request, this.metadata, (error, response) => {
          if (error) {
            handleError(error, reject);
          } else {
            const code = response.getCode();
    ...
    listTask = (queryRequest) => {
      return new Promise((resolve, reject) => {
        ...
        this.client.listTask(request, this.metadata, (error, response) => {
          if (error) {
            handleError(error, reject);
          } else {
            const code = response.getCode();
                ...
                for (const task of dataList) {
                  ...
                  if (task.isComplete == 'true') {
                    ...
                    try {
                      ...
                      console.log(`[error] on listTask, err: ${error_}`);
    ...
    completeTask = (noteId, taskId, complete) => {
      return new Promise((resolve, reject) => {
        ...
        this.client.completeTask(request, this.metadata, (error, response) => {
          if (error) {
            handleError(error, reject);
          } else {
            const code = response.getCode();
