 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.yartu.SaveToMyDriveInternalFileRequest,
 *   !proto.yartu.SaveToMyDriveInternalFileResponse>}
 */
const methodDescriptor_YDrive_saveToMyDriveInternalFile = new grpc.web.MethodDescriptor(
  '/yartu.YDrive/saveToMyDriveInternalFile',
  grpc.web.MethodType.UNARY,
  proto.yartu.SaveToMyDriveInternalFileRequest,
  proto.yartu.SaveToMyDriveInternalFileResponse,
  /**
   * @param {!proto.yartu.SaveToMyDriveInternalFileRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.yartu.SaveToMyDriveInternalFileResponse.deserializeBinary
);


/**
 * @param {!proto.yartu.SaveToMyDriveInternalFileRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.yartu.SaveToMyDriveInternalFileResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.yartu.SaveToMyDriveInternalFileResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.yartu.YDriveClient.prototype.saveToMyDriveInternalFile =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/yartu.YDrive/saveToMyDriveInternalFile',
      request,
      metadata || {},
      methodDescriptor_YDrive_saveToMyDriveInternalFile,
      callback);
};
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.yartu.SaveToMyDriveInternalFileResponse>}
 *     Promise that resolves to the response
 */
proto.yartu.YDrivePromiseClient.prototype.saveToMyDriveInternalFile =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/yartu.YDrive/saveToMyDriveInternalFile',
      request,
